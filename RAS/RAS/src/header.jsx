export default function Header() {
  return (
    <section
      className="relative py-12 overflow-hidden bg-black sm:pb-16 lg:pb-20 xl:pb-24"
        ...
        <div className="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 gap-x-16">
          <div>
            ...
            <p className="mt-4 text-lg font-normal text-gray-400 sm:mt-8">
              Your trusted partner for Salesforce Marketing Cloud and Full Stack
          ...
          <div className="relative">
            ...
            <img
              ...
              src="./src/assets/marketing-hero-image.png"
              alt=""
            />
          </div>
        </div>
